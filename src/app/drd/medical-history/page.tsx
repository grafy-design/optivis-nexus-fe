    ...
    <AppLayout headerType="drd" drdStep={1} scaleMode="none">
      ...
      <div style={{ display: "flex", flex: 1, gap: "0px",  minHeight: 0, alignItems: "stretch", overflow: "hidden" }}>
         ...
         {/* 오른쪽 상위 배경 카드: selection-bg.png → 안에 흰색 테이블 카드 */}
             <div className="drd-right-panel flex-[78] min-w-0 min-h-0 self-stretch flex flex-col" style={{ borderImage: 'url("/assets/figma/home/frame-panel-middle.png") 72 fill / 36px / 0 stretch', borderStyle: "solid", borderTopWidth: "20px", borderBottomWidth: "28px", borderLeftWidth: "24px", borderRightWidth: "24px", borderColor: "transparent", gap: "12px" }}>


            {/* 상단: 제목 + 버튼들 */}
            <div className="shrink-0 flex items-center justify-between gap-[24px] pl-[8px] pr-0">
              <h2 className="font-['Inter'] font-semibold text-[24px] leading-[1.2] text-[#262255] tracking-[-0.72px] m-0">
                Medical History
              </h2>
              <div className="flex items-center gap-[12px]">
                {/* Test 버튼 */}
                <button className="flex items-center justify-center h-[44px] w-[96px] pl-[20px] pr-[24px] rounded-[36px] border-none cursor-pointer relative overflow-hidden shadow-[0px_0px_2px_0px_rgba(0,0,0,0.05)]">
                  <div className="absolute inset-0 bg-[#242424] mix-blend-screen opacity-30 rounded-[36px]" />
                  <div className="absolute inset-0 border-2 border-solid border-[rgba(255,255,255,0.3)] rounded-[36px]" />
                  <span className="relative z-10 font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#0d063c] tracking-[-0.51px]">
                    Test
                  </span>
                </button>
                {/* Reset 버튼 */}
            ...
            <div className="flex flex-1 min-h-0 gap-[10px] items-stretch">
              ...
              <div className="flex-1 flex flex-col gap-[20px] p-[16px] rounded-[24px] bg-[rgba(255,255,255,0.6)] overflow-auto scrollbar-hide">
                {/* 제목 */}
                <div className="font-['Inter'] font-semibold text-[19.5px] leading-[1.12] tracking-[-0.78px] shrink-0">
            ...
            {/* 하단 버튼 */}
             <div className="shrink-0 flex justify-end gap-[12px]">
              ...
              <button
                onClick={() => { setCompleted("medical-history", true); router.push("/drd/default-setting"); }}
