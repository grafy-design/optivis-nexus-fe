...
function GlassTestButton() {
  return (
    ...
    >
      {/* Fill layer: color-dodge로 밝은 유리 효과 */}
      <div
        style={{
          position: "absolute",
          inset: 0,
        ...
        <div className="flex flex-1 min-h-0 items-stretch" style={{ gap: "0px" }}>
         ...
         {/* 오른쪽 상위 배경 카드: selection-bg.png → 안에 흰색 테이블 카드 */}
           <div className="drd-right-panel flex-[78] min-w-0 min-h-0 flex flex-col" style={{ borderImage: 'url("/assets/figma/home/frame-panel-middle.png") 72 fill / 36px / 0 stretch', borderStyle: "solid", borderTopWidth: "20px", borderBottomWidth: "28px", borderLeftWidth: "24px", borderRightWidth: "24px", borderColor: "transparent", gap: "12px"}}>
              ...
              {/* 상단 섹션: 제목 + Reset */}
              <div className="flex justify-between items-center shrink-0 pl-[8px] pr-0">
              ...
              <div className="flex flex-1 min-h-0 gap-[12px]">
                ...
                <div className="flex-1 flex flex-col gap-[20px] p-[16px] rounded-[24px] bg-[rgba(255,255,255,0.6)] overflow-auto scrollbar-hide">
                  <div className="font-['Inter'] font-semibold text-[19.5px] leading-[1.12] tracking-[-0.78px]">
                    ...
                    <div className="bg-[#f9f8fc] rounded-[8px] px-[12px] py-[10px] flex flex-col gap-[24px]">
                      ...
                      <div className="flex flex-col">
                        ...
                        {[
                          ...
                          <div key={item.label} className="border-solid flex items-center gap-[8px] py-[8px]" style={{ borderTop: "1.5px solid #c7c5c9" }}>
                            <RadioButton checked={trendSelection === item.label} onChange={() => setTrendSelection(item.label)} />
            ...
            <div className="shrink-0 flex justify-end gap-[12px]">
              ...
              <button
                onClick={() => { setCompleted("patient-disease-info", true); router.push("/drd/default-setting"); }}
