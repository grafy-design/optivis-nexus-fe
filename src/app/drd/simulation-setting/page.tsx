    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, height: 40 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          <span style={{ fontFamily: "Inter", fontSize: 24, fontWeight: 600, color: "rgb(72,70,70)", letterSpacing: "-0.72px", lineHeight: "1.2" }}>
            {title}
          </span>
          {required && (
            <span style={{ fontFamily: "Inter", fontSize: 24, fontWeight: 600, color: "rgb(64,19,238)" }}>*</span>
          )}
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <p style={{
          ...
          color: "rgb(145,144,146)", letterSpacing: "-0.51px", lineHeight: "1.3", margin: 0,
        }}>
          {description}
        </p>
        <button
  ...
  return (
    <div style={{ ...(isFirst ? {} : { borderTop: "1px solid #c6c5c9" }), display: "flex", gap: 12, alignItems: "flex-start", paddingTop: 10, paddingBottom: 10 }}>
      <div style={{ width: 120, flexShrink: 0 }}>
        <span style={{ fontFamily: "Inter", fontSize: 12, fontWeight: 600, color: "#787776", letterSpacing: "-0.36px", lineHeight: "1.18" }}>{label}</span>
      </div>
      <div style={{ flex: 1 }}>
        <span style={{ fontFamily: "Inter", fontSize: 12, fontWeight: 600, color: "#484646", letterSpacing: "-0.36px", lineHeight: "1.18" }}>{value}</span>
      </div>
    </div>
  );
}
    ...
    <div style={{ width: "100%" }}>
      ...
      <div style={{
        ...
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0 }}>
          <circle cx="8" cy="8" r="7" stroke="#C6C5C9" strokeWidth="1.2"/>
          <path d="M8 7v4M8 5.5v.5" stroke="#C6C5C9" strokeWidth="1.2" strokeLinecap="round"/>
        </svg>
      </div>
      {/* Body */}
      <div style={{
        background: "white", borderRadius: "0 0 16px 16px",
        padding: "12px 16px 16px 16px", display: "flex", flexDirection: "column", gap: 4,
      }}>
        {drugs.map((drug, i) => (
          <div key={i} style={{ fontFamily: "Inter", fontSize: 12, fontWeight: 600, color: "#484646", letterSpacing: "-0.36px", lineHeight: "1.18" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ background: "white", borderRadius: 16, padding: "4px 16px" }}>
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start", paddingTop: 10, paddingBottom: 10 }}>
              <div style={{ width: 120, flexShrink: 0 }}>
                <span style={{ fontFamily: "Inter", fontSize: 12, fontWeight: 600, color: "#787776", letterSpacing: "-0.36px", lineHeight: "1.18" }}>Selected Value</span>
              </div>
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 2 }}>
                <span style={{ fontFamily: "Inter", fontSize: 12, fontWeight: 600, color: "#484646", letterSpacing: "-0.36px", lineHeight: "1.18" }}>HbA1c</span>
                <span style={{ fontFamily: "Inter", fontSize: 12, fontWeight: 500, color: "#919092", letterSpacing: "-0.36px", lineHeight: "1.18" }}>Increase (3m) / Stable (6m) / Decrease (3m)</span>
              </div>
            </div>
              ...
              >
                <div style={{ display: "flex", flexDirection: "column", gap: 8, width: "100%" }}>
                  <div style={{ display: "flex", gap: 18, alignItems: "center" }}>
                    ...
                    <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 19.5, color: "#484646", letterSpacing: "-0.78px", lineHeight: 1.12 }}>Simulation Conditions</span>
                  </div>
