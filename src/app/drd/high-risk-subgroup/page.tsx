...
export default function HighRiskSubgroupPage() {
  ...
  const setCompleted = useDefaultSettingStore((s) => s.setCompleted);
      ...
      <div style={{ display: "flex", flexDirection: "column", width: "calc(100% - 24px)", height: "100%", gap: 24, overflow: "hidden", marginLeft: "8px", marginRight: "8px" }}>
        ...
        <div style={{ display: "flex", flex: 1, gap: "0px",  minHeight: 0, alignItems: "stretch", overflow: "hidden" }}>
              ...
              <div className="relative z-10 flex flex-col h-full gap-[0px]">
                ...
                <div style={{ marginTop: "24px" }}>
                  <div className="relative h-[18px] w-full rounded-[12px] bg-[rgba(0,0,0,0.2)] overflow-hidden">
                    <div className="absolute left-0 top-0 h-full w-[324px] bg-[#f06600] rounded-[12px]" />
                    <div className="absolute inset-0 flex items-center justify-end pr-[11px]">
                      <span className="font-['Inter'] font-semibold text-[13px] leading-[1.18] text-white tracking-[-0.36px] mix-blend-screen">
                        360/360 patients
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-[2px] mt-auto">
                  ...
                  <div className="flex gap-[11px]">
                    <div className="flex gap-[3px] items-center">
                      ...
                      <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-white tracking-[-0.75px] w-[86px]">4,800</span>
                    </div>
                    <div className="flex gap-[3px] items-center">
         ...
         {/* 오른쪽 상위 배경 카드: selection-bg.png → 안에 흰색 테이블 카드 */}
            ...
            <div className="shrink-0 flex items-center justify-between pl-[4px] pr-[4px]">
            ...
            <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
              <div className="bg-white rounded-[24px] flex flex-col overflow-hidden h-full">
                ...
                >
                  ...
                  <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[20px] shrink-0">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Detail
                    </span>
                  </div>
                  {/* Set Name */}
                  <div className="flex items-center px-[10px] w-[17.94%] h-[20px] border-l border-[#e2e1e5] shrink-0">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Set Name
                    </span>
                  </div>
                  {/* Outcome */}
                  <div className="flex items-center px-[8px] w-[20.04%] h-[20px] border-l border-[#e2e1e5] shrink-0">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Outcome
                    </span>
                  </div>
                  {/* Cutoff */}
                  <div className="flex items-center px-[8px] w-[14.31%] h-[20px] border-l border-[#e2e1e5] shrink-0">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Cutoff
                    </span>
                  </div>
                  {/* Month */}
                  <div className="flex items-center px-[8px] w-[11.45%] h-[20px] border-l border-[#e2e1e5] shrink-0">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Month
                    </span>
                  </div>
                  ...
                  {/* Group balance */}
                  <div className="flex items-center px-[8px] w-[17.18%] h-[20px] border-l border-[#e2e1e5] shrink-0">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Group balance
                    </span>
                  </div>
                  {/* Update date */}
                  <div className="flex items-center pl-[8px] pr-[4px] flex-1 h-[20px] border-l border-[#e2e1e5]">
                    <span className="font-['Inter'] font-semibold text-[17px] leading-[1.05] text-[#484646] tracking-[-0.51px]">
                      Update date
                    </span>
                  </div>
                ...
                <div className="flex-1 overflow-y-auto scrollbar-hide flex flex-col">
                  ...
                  {/* CKD 1 Stage */}
                  <div className={`flex flex-col shrink-0 ${expandedRows.has("ckd1") || ["ckd1-slow","ckd1-rapid"].includes(selectedSubRow ?? "") ? "bg-[#f3eeff] border-solid" : "border-b border-[#c7c5c9] border-solid bg-white"}`} style={expandedRows.has("ckd1") || ["ckd1-slow","ckd1-rapid"].includes(selectedSubRow ?? "") ? { borderTop: "1px solid #3a11d8", borderBottom: "1px solid #3a11d8" } : {}}>
                    <div className="flex items-center h-[56px] py-[14px] overflow-clip cursor-pointer" onClick={() => toggleRow("ckd1")}>
                      ...
                      <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">
                          CKD 1 Stage
                        </span>
                      </div>
                      <div className="flex items-center px-[10px] w-[20.04%] h-[28px] border-l border-[#acaaad] shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px]">
                          eGFR
                        </span>
                      </div>
                      <div className="flex items-center px-[10px] w-[14.31%] h-[28px] border-l border-[#acaaad] shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px]">
                          ≤ 90
                        </span>
                      </div>
                      <div className="flex items-center px-[10px] w-[11.45%] h-[28px] border-l border-[#acaaad] shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px]">
                          36
                        </span>
                      </div>
                      ...
                      <div className="flex items-center px-[10px] w-[17.18%] h-[28px] border-l border-[#acaaad] shrink-0">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px]">
                          OK (n min=150)
                        </span>
                      </div>
                      <div className="flex items-center px-[10px] flex-1 h-[28px] border-l border-[#acaaad]">
                        <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px]">
                          2025/12/25 17:00:01
                        </span>
                      </div>
                    ...
                    {expandedRows.has("ckd1") && (
                      <>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #3a11d8", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("ckd1-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("ckd1-slow")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #919092", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("ckd1-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("ckd1-rapid")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                  ...
                  {/* CKD 2 Stage */}
                  <div className={`flex flex-col shrink-0 ${expandedRows.has("ckd2") || ["ckd2-slow","ckd2-rapid"].includes(selectedSubRow ?? "") ? "bg-[#f3eeff] border-solid" : "border-b border-[#c7c5c9] border-solid bg-white"}`} style={expandedRows.has("ckd2") || ["ckd2-slow","ckd2-rapid"].includes(selectedSubRow ?? "") ? { borderTop: "1px solid #3a11d8", borderBottom: "1px solid #3a11d8" } : {}}>
                    <div className="flex items-center h-[56px] py-[14px] overflow-clip cursor-pointer" onClick={() => toggleRow("ckd2")}>
                      <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                        <div className="w-[20px] h-[20px] flex items-center justify-center">
                    ...
                    {expandedRows.has("ckd2") && (
                      <>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #3a11d8", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("ckd2-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("ckd2-slow")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">Slow</span>
                          </div>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #919092", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("ckd2-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("ckd2-rapid")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">Rapid</span>
                          </div>
                  ...
                  {/* Set 1 */}
                  <div className={`flex flex-col shrink-0 ${expandedRows.has("set1") || ["set1-slow","set1-rapid"].includes(selectedSubRow ?? "") ? "bg-[#f3eeff] border-solid" : "border-b border-[#c7c5c9] border-solid bg-white"}`} style={expandedRows.has("set1") || ["set1-slow","set1-rapid"].includes(selectedSubRow ?? "") ? { borderTop: "1px solid #3a11d8", borderBottom: "1px solid #3a11d8" } : {}}>
                    <div className="flex items-center h-[56px] py-[14px] overflow-clip cursor-pointer" onClick={() => toggleRow("set1")}>
                      <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                        <div className="w-[20px] h-[20px] flex items-center justify-center">
                    ...
                    {expandedRows.has("set1") && (
                      <>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #3a11d8", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("set1-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("set1-slow")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">Slow</span>
                          </div>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #919092", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("set1-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("set1-rapid")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">Rapid</span>
                          </div>
                  ...
                  {/* Set 4 */}
                  <div className={`flex flex-col shrink-0 ${expandedRows.has("set4") || ["set4-slow","set4-rapid"].includes(selectedSubRow ?? "") ? "bg-[#f3eeff] border-solid" : "border-b border-[#c7c5c9] border-solid bg-white"}`} style={expandedRows.has("set4") || ["set4-slow","set4-rapid"].includes(selectedSubRow ?? "") ? { borderTop: "1px solid #3a11d8", borderBottom: "1px solid #3a11d8" } : {}}>
                    <div className="flex items-center h-[56px] py-[14px] overflow-clip cursor-pointer" onClick={() => toggleRow("set4")}>
                      <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                        <div className="w-[20px] h-[20px] flex items-center justify-center">
                    ...
                    {expandedRows.has("set4") && (
                      <>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #3a11d8", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("set4-slow")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("set4-slow")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">Slow</span>
                          </div>
                        ...
                        <div className="flex items-center h-[56px] py-[14px] overflow-clip border-solid cursor-pointer" style={{ borderTop: "1.5px solid #919092", background: isSel ? "#f7f3ff" : "#fbf9ff", opacity: 1 }} onClick={() => setSelectedSubRow("set4-rapid")}>
                          <div className="flex items-center justify-center pl-[12px] pr-[8px] w-[7.63%] h-[28px] shrink-0">
                            <RadioButton checked={isSel} onChange={() => setSelectedSubRow("set4-rapid")} size={16} />
                          </div>
                          <div className="flex items-center px-[10px] w-[17.94%] h-[28px] border-l border-[#acaaad] shrink-0">
                            <span className="font-['Inter'] font-semibold text-[15px] leading-[1.15] text-[#5f5e5e] tracking-[-0.75px] flex-1 min-w-0">Rapid</span>
                          </div>
            ...
            <div className="shrink-0 flex justify-end gap-[12px] p-0 m-0">
              ...
              <button
                onClick={() => { setCompleted("high-risk-subgroup", true); router.push("/drd/default-setting"); }}
