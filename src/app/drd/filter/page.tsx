...
function IconFolderPlus({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M3 7V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V9C21 7.9 20.1 7 19 7H11L9 5H5C3.9 5 3 5.9 3 7Z" stroke="#c6c5c9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 11V17M15 14H9" stroke="#c6c5c9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export default function FilterPage() {
  ...
  const { setCompleted } = useDefaultSettingStore();
  ...
  const [activeCat, setActiveCat] = useState<string>("INFO");
        ...
        <div style={{ display: "flex", flex: 1, gap: "0px",  minHeight: 0, alignItems: "stretch", overflow: "hidden" }}>
         ...
         <div
              ...
              <div className="relative z-10 flex flex-col h-full gap-[0px]">
                <div className="flex justify-between items-start">
                  <div className="flex flex-col gap-[4px]">
                    ...
                    <span className="font-['Inter'] font-semibold text-[36px] leading-none text-white tracking-[-1.08px]">100%</span>
                  </div>
                ...
                <div style={{ marginTop: "24px" }}>
                  <div className="relative h-[18px] w-full rounded-[12px] bg-[rgba(0,0,0,0.2)] overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-end pr-[11.13px]">
                      <span className="font-['Inter'] font-semibold text-[13px] leading-[1.18] text-white tracking-[-0.36px] mix-blend-screen text-right">360/360 patients</span>
                    </div>
                  </div>
                </div>
          ...
          {/* 오른쪽 상위 배경 카드: selection-bg.png → 안에 흰색 테이블 카드 */}
            ...
            <div className="shrink-0 px-[8px] flex items-center justify-between h-[54px]">
            ...
            <div className="flex flex-1 min-h-0 gap-[12px]">
              ...
              <div className="w-[272px] shrink-0 flex flex-col gap-[12px]">
                ...
                <div ref={searchContainerRef} className="relative">
                  <div className="h-[44px] bg-white rounded-[36px] flex items-center px-[18px] gap-[8px]">
                    <IconSearch size={20} />
                    <input
                      ref={searchInputRef}
                      type="text"
                  ...
                  {/* 검색 드롭다운 */}
                  {searchDropdownOpen && Object.keys(groupedSearchResults).length > 0 && typeof document !== "undefined" && createPortal(
                    <div
                    ...
                    >
                      {Object.entries(groupedSearchResults).map(([category, features], catIdx) => (
                        <React.Fragment key={category}>
                          {catIdx > 0 && <div style={{ height: 1, background: "#919092" }} />}
                          {/* 카테고리 헤더 */}
                          ...
                          {features.map((f, fIdx) => (
                            ...
                            >
                              ...
                              <span style={{
                                fontFamily: "Inter", fontWeight: 500, fontSize: 12,
                                color: "#aaaaad", letterSpacing: "-0.48px", lineHeight: 1.1,
              ...
              <div className="flex-1 flex flex-col gap-[12px] rounded-[24px] bg-[rgba(255,255,255,0.6)] p-[12px] overflow-hidden">
                ...
                <div className="flex justify-between items-center shrink-0">
                  ...
                  <div className="flex items-center gap-[12px]">
                    <div className="flex gap-[4px]">
                      <button className="size-[48px] rounded-[36px] flex items-center justify-center cursor-pointer shadow-[0px_0px_2px_rgba(0,0,0,0.05)] bg-white/60 hover:bg-white/80 transition-colors">
                    ...
                    >
                      <span className="font-['Inter'] font-semibold text-[15px] text-[#929090] tracking-[-0.51px]">Add Section</span>
                      <IconPlus size={16} color="#929090" />
                    </button>
                  </div>
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="bg-white p-[16px] rounded-[12px] shrink-0 min-h-[52px]">
                      <div className="font-medium text-[15px] leading-[1.1] text-[#929090] tracking-[-0.45px] flex flex-col gap-[4px] font-['Inter']">
                        {lines.length === 0 ? null : lines.map((line, i) => (
                          <p key={i} className="m-0">
                            {i === 0
                              ? <><span className="text-[#f06600] font-semibold">{activeTab}</span> [ &nbsp;{line.text}</>
            ...
            <div className="shrink-0 flex justify-end gap-[12px]">
              ...
              <button
                onClick={() => { setCompleted("filter", true); router.push("/drd/default-setting"); }}
